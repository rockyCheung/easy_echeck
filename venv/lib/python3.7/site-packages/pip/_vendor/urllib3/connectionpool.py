...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    :param _proxy:
        Parsed proxy URL_LIST, should not be used directly, instead, see
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    def _new_conn(self):
        ...
        if not self.ConnectionCls or self.ConnectionCls is DummyConnection:
            raise SSLError("Can't connect to HTTPS URL_LIST because the SSL "
...
def connection_from_url(url, **kw):
    ...
    :param url:
        Absolute URL_LIST string that must include the scheme. Port is optional.
