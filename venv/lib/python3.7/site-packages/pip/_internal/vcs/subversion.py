...
class Subversion(VersionControl):
    ...
    def get_netloc_and_auth(self, netloc, scheme):
        ...
        --username and --password options instead of via the URL_LIST.
        """
        if scheme == 'ssh':
            # The --username and --password options can't be used for
            # svn+ssh URLs, so keep the auth information in the URL_LIST.
    ...
    def get_url_rev_and_auth(self, url):
        # hotfix the URL_LIST scheme after removing svn+ from svn+ssh:// readd it
    ...
    def _get_svn_url_rev(cls, location):
        ...
        if (data.startswith('8') or
            ...
            url = match.group(1)    # get repository URL_LIST
