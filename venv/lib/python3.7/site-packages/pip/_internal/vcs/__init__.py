...
class VersionControl(object):
    ...
    def get_netloc_and_auth(self, netloc, scheme):
        """
        Parse the repository URL_LIST's netloc, and return the new netloc to use
        along with auth information.

        Args:
          netloc: the original repository URL_LIST netloc.
          scheme: the repository URL_LIST's scheme without the vcs prefix.

        This is mainly for the Subversion class to override, so that auth
        information can be provided via the --username and --password options
        instead of through the URL_LIST.  For other subclasses like Git without
        such an option, auth information must stay in the URL_LIST.
    ...
    def get_url_rev_and_auth(self, url):
        ...
        """
        Parse the repository URL_LIST to use, and return the URL_LIST, revision,
    ...
    def get_url_rev_options(self, url):
        ...
        """
        Return the URL_LIST and RevOptions object to use in obtain() and in
    ...
    def normalize_url(self, url):
        # type: (str) -> str
        """
        Normalize a URL_LIST for comparison by unquoting it and removing any
        trailing slash.
        """
    ...
    def switch(self, dest, url, rev_options):
        """
        Switch the repo at ``dest`` to point to ``URL_LIST``.
    ...
    def obtain(self, dest):
        ...
        if self.is_repository_directory(dest):
            ...
            if self.compare_urls(existing_url, url):
                logger.debug(
                    '%s in %s exists, and has correct URL_LIST (%s)',
            ...
            logger.warning(
                '%s %s in %s exists with URL_LIST %s',
                self.name,
                self.repo_name,
                display_path(dest),
                existing_url,
