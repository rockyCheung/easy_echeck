...
class InstallRequirement(object):
    ...
    def hashes(self, trust_internet=True):
        # type: (bool) -> Hashes
        """Return a hash-comparer that considers my option- and URL_LIST-based
        ...
        :param trust_internet: Whether to trust URL_LIST-based (#md5=...) hashes
